...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTest
    {
        ...
        public void CanAddBasketItem()
        {
            ...
            //Act
            // basketService.AddToBasket(httpContext, "1"); Test The service Function
            controller.AddToBasket("1"); // test the controller 
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer { Id = "1", 
                                            Email = "artemtartmin@gmail.com",
                                            ZipCode="90210" });

            IPrincipal FakeUser =new GenericPrincipal(new GenericIdentity("artemtartmin@gmail.com","Forms"),null);
